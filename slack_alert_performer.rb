    ...
    module Processor
      module Check
        class SlackAlertPerformer
          ...
          def count_check_period
            data.dig(:arguments, :count_check_period)
          end

          def processor_runs_check_period
            data.dig(:arguments, :processor_runs_check_period)
          end
